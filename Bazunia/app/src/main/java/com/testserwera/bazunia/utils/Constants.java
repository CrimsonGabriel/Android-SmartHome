...
public class Constants {
    public static final String ACTION_DATA_UPDATED = "com.testserwera.bazunia.DATA_UPDATED";
    public static final String ACTION_SYNC_STATUS = "com.testserwera.bazunia.ACTION_SYNC_STATUS";
